      ...
      async (email, password, done) => {
        try {
          ...
          const transformedUser = {
            ...safeUser,
            is_admin: safeUser.is_admin === 1,
            is_super_admin: safeUser.is_super_admin === 1,
            is_enabled: safeUser.is_enabled === 1,
            is_south_african: safeUser.is_south_african === 1,
            has_credit_card: safeUser.has_credit_card === 1
          };
