                      ...
                      >
                        ...
                        <div 
                          className={`relative overflow-hidden transition-all duration-500 ${
                            isExpanded ? 'w-[200%] z-20 mx-auto clearfix' : 'w-full cursor-pointer'
                          }`}
                          onClick={() => {
                        ...
                        >
                          {/* Image Container */}
                          <div className={`relative ${isExpanded ? 'h-64 w-full md:w-1/3 md:h-full md:float-left' : 'h-72 md:h-96'}`}>
                            <img 
                              src={member.image} 
                              alt={member.name}
                          ...
                          {isExpanded && (
                            <div className={`p-6 bg-[#01162f]/95 h-full md:min-h-[24rem] md:w-2/3 md:float-left`}>
