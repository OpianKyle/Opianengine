    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-white dark:bg-[#01162f] text-foreground dark:text-white py-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto mb-12 text-[#022b5c] dark:text-[#43EB3E]">
            ...
            {steps.map((step) => (
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-[#022b5c] dark:text-[#43EB3E]">{step.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 bg-white dark:bg-[#01162f] text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto text-[#022b5c] dark:text-[#43EB3E]">
