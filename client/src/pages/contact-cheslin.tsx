...
export default function ContactCheslin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/contact/cheslin', {
        method: 'POST',
        headers: {
      ...
      toast({
        ...
        description: "Cheslin will get back to you within 24 hours.",
      });
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <Card className="bg-white shadow-xl">
            <CardHeader className="text-center">
              <div className="mx-auto mb-4">
                <img 
                  ...
                  className="w-40 h-40 rounded-full object-cover object-top border-4 border-green-200 shadow-lg"
                />
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-3 text-gray-600">
                ...
                <span>cheslin@opianrewards.com</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-600">
          ...
          <Card className="bg-white shadow-xl">
            <CardHeader>
              ...
              <CardDescription>
                Fill out the form below and Cheslin will respond within 24 hours
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    required
                    rows={4}
                    placeholder="Tell Cheslin how he can help you..."
                  />
                </div>
