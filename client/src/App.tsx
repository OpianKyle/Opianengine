...
import TestSubscriptionPage from "@/pages/test-subscription-page"; // Import the test subscription page
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/admin/test-subscription">
        <AdminLayout>
          <ProtectedRoute component={TestSubscriptionPage} admin />
        </AdminLayout>
      </Route>
