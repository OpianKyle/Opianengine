        ...
        <Card style={styles.welcomeCard}>
          <Card.Content>
            <View style={styles.welcomeCardContent}>
              ...
              <Avatar.Text size={50} label={getInitials(user)} color="#FFF" style={styles.avatar} />
            </View>
          </Card.Content>
        </Card>
        ...
        <Card style={styles.card}>
          <Card.Content>
            ...
            <Text style={styles.cardDescription}>
              Share your referral code with friends and earn 2,000 points for each successful referral!
            </Text>
            <View style={styles.referralCodeContainer}>
              <Text style={styles.referralCode}>{user?.referralCode || 'OPIANNEW'}</Text>
            </View>
            <Button 
              mode="contained" 
              style={styles.button}
